...
{if ("" != null) return tmpStatement;}
  ...
  final public IrisStatement authority_statement() throws ParseException {IrisIdentifier methodName = null;
...
tar = IrisAuthorityStatement.Target.ClassMethod;
    ...
    jj_consume_token(RB);
{if ("" != null) return new IrisAuthorityStatement(methodName, tar, auth);}
    throw new Error("Missing return statement in function");
  }

  final public IrisAuthorityStatement.Authority authority() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case EVERYONE:{
      jj_consume_token(EVERYONE);
{if ("" != null) return IrisAuthorityStatement.Authority.Everyone;}
      break;
      }
    case RELATIVE:{
      jj_consume_token(RELATIVE);
{if ("" != null) return IrisAuthorityStatement.Authority.Relative;}
      break;
      }
    case PERSONAL:{
      jj_consume_token(PERSONAL);
{if ("" != null) return IrisAuthorityStatement.Authority.Personal;}
      break;
      }
    default:
      jj_la1[4] = jj_gen;
  ...
  final public IrisStatement groan_statement() throws ParseException {IrisExpression tmpExpr = null;
  IrisStatement tmpStmt = null;
  Token tmpToken = null;
    jj_consume_token(SEMICOLON);
    tmpToken = jj_consume_token(GROAN);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CAST:
    case SELF:
    case TRUE:
...
tmpStmt = new IrisGroanStatement(tmpExpr);
          ...
          {if ("" != null) return tmpStmt;}
    throw new Error("Missing return statement in function");
  }

  final public IrisStatement order_statement() throws ParseException {IrisBlock tmpOrderBlock = null;
  IrisBlock tmpServeBlock = null;
  IrisBlock tmpIgnoreBlock = null;
  IrisIdentifier tmpIrregularObject = null;
  IrisStatement tmpStmt = null;
  Token tmpToken = null;
    tmpToken = jj_consume_token(ORDER);
    tmpOrderBlock = block();
    jj_consume_token(SERVE);
    jj_consume_token(LP);
    tmpIrregularObject = identifier();
    jj_consume_token(RP);
    tmpServeBlock = block();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IGNORE:{
      jj_consume_token(IGNORE);
      tmpIgnoreBlock = block();
      break;
      }
    default:
      jj_la1[6] = jj_gen;
...
tmpStmt = new IrisOrderStatement(tmpOrderBlock, tmpIrregularObject, tmpServeBlock, tmpIgnoreBlock);
  ...
  final public IrisStatement getter_statement() throws ParseException {IrisIdentifier tmpIdentifier = null;
...
tmpStmt = new IrisGetterStatement(tmpIdentifier, tmpBlock);
  ...
  final public IrisStatement setter_statement() throws ParseException {IrisIdentifier tmpIdentifier = null;
...
tmpStmt = new IrisSetterStatement(tmpIdentifier, tmpParam, tmpBlock);
  ...
  final public IrisStatement gsetter_statement() throws ParseException {IrisIdentifier tmpIdentifier = null;
  IrisStatement tmpStmt = null;
  Token tmpToken = null;
    jj_consume_token(SEMICOLON);
    tmpToken = jj_consume_token(GSET);
    jj_consume_token(LB);
    tmpIdentifier = identifier();
    jj_consume_token(RB);
tmpStmt = new IrisGSetterStatement(tmpIdentifier);
  ...
  final public IrisStatement module_statement() throws ParseException {IrisIdentifier tmpModuleName = null;
  LinkedList<IrisExpression> tmpModules = null;
  IrisBlock tmpBlock = null;
  IrisStatement tmpStmt = null;
  Token tmpToken = null;
m_defineStack.push(IrisParserDefineType.Module);
    tmpToken = jj_consume_token(MODULE);
...
m_defineStack.pop();
  ...
  final public IrisStatement class_statement() throws ParseException {IrisIdentifier tmpClassName = null;
...
m_defineStack.push(IrisParserDefineType.Class);
    tmpToken = jj_consume_token(CLASS);
...
m_defineStack.pop();
  ...
  final public IrisExpression extends_field() throws ParseException {IrisExpression tmpExpression = null;
...
{if ("" != null) return tmpExpression;}
  ...
  final public LinkedList<IrisExpression> module_field() throws ParseException {LinkedList<IrisExpression> tmpList = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INVOLVES:{
      jj_consume_token(INVOLVES);
      tmpList = field_identifier_list();
{if ("" != null) return tmpList;}
      break;
      }
    default:
      jj_la1[11] = jj_gen;
{if ("" != null) return tmpList;}
  ...
  final public LinkedList<IrisExpression> interface_field() throws ParseException {LinkedList<IrisExpression> tmpList = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case JOINTS:{
      jj_consume_token(JOINTS);
      tmpList = field_identifier_list();
{if ("" != null) return tmpList;}
      break;
      }
...
{if ("" != null) return tmpList;}
  ...
  final public LinkedList<IrisExpression> field_identifier_list() throws ParseException {IrisIdentifier tmpIdentifier = null;
...
tmpStat = new IrisFunctionStatement(tmpHeader, tmpWithBlock, tmpWithoutBlock, tmpBlock, m_defineStack.lastElement());
  ...
  final public IrisFunctionHeader function_header() throws ParseException {IrisIdentifier tmpIdentifier = null;
    ...
    tmpToken = jj_consume_token(FUNCTION);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SELF:{
      jj_consume_token(SELF);
      jj_consume_token(DOT);
...
{if ("" != null) return identifiers;}
  ...
  final public IrisStatement for_statement() throws ParseException {IrisIdentifier tmpIter1 = null;
  IrisIdentifier tmpIter2 = null;
  IrisExpression tmpSource = null;
  IrisBlock tmpBlock = null;
  Token tmpToken = null;
  IrisStatement tmpStat = null;
    tmpToken = jj_consume_token(FOR);
    jj_consume_token(LP);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CONSTANCE:
    case LOCALVARIABLE:
...
tmpStat = new IrisForStatement(tmpIter1, tmpIter2, tmpSource, tmpBlock);
  ...
  final public IrisStatement break_statement() throws ParseException {Token tmpToken = null;
    IrisStatement tmpStat = null;
    jj_consume_token(SEMICOLON);
    tmpToken = jj_consume_token(BREAK);
tmpStat = new IrisBreakStatement(null);
  ...
  final public IrisStatement continue_statement() throws ParseException {Token tmpToken = null;
    IrisStatement tmpStat = null;
    jj_consume_token(SEMICOLON);
    tmpToken = jj_consume_token(CONTINUE);
tmpStat = new IrisContinueStatement(null);
  ...
  IrisStatement tmpStat = null;
    jj_consume_token(SEMICOLON);
    tmpToken = jj_consume_token(RETURN);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CAST:
    case SELF:
    case TRUE:
...
{if ("" != null) return statementList;}
  ...
  final public IrisStatement switch_statement() throws ParseException {IrisExpression conditionExpression = null;
        ...
        Token tmpToken = null;
        IrisStatement tmpStat = null;
    tmpToken = jj_consume_token(SWITCH);
    jj_consume_token(LP);
...
tmpExprResult = new IrisTopExpression(tmpExpression, tmpExpression2).ToDirectExpression();
    ...
    {if ("" != null) return tmpExprResult;}
    throw new Error("Missing return statement in function");
  }

  final public IrisTopExpressionApostrophe top_expression_apostrophe() throws ParseException {IrisIdentifier tmpIdentifier = null;
...
tmpFore = new IrisTopExpressionApostropheForeIndex(tmpExpression);
      ...
      tmpExpression2 = top_expression_apostrophe();
{if ("" != null) return new IrisTopExpressionApostrophe(tmpFore, tmpExpression2);}
      break;
      }
    default:
      jj_la1[46] = jj_gen;
{if ("" != null) return null;}
  ...
  final public IrisClosureBlockLiteral closure_block() throws ParseException {IrisIdentifier tmpVariableParameter = null;
  LinkedList<IrisIdentifier> tmpParameters = null;
  LinkedList<IrisStatement> tmpStatements = null;
    ...
    jj_consume_token(RC);
{if ("" != null) return new IrisClosureBlockLiteral(tmpParameters, tmpVariableParameter, new IrisBlock(tmpStatements));}
    throw new Error("Missing return statement in function");
  }
...
*/
  final public 
IrisExpression hide_function_call() throws ParseException {IrisExpression tmpCaller = null;
   IrisIdentifier tmpIdentifier = null;
   LinkedList<IrisExpression> expressions = null;
   IrisExpression tmpExpression = null;
   IrisClosureBlockLiteral tmpClosureBlock = null;
...
*/
  final public 
IrisExpression primary_expression() throws ParseException {IrisExpression tmpExpression = null;
  Token tmpToken = null;
  IrisIdentifier tmpIdentifier = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LP:{
...
tmpExpression = new IrisInstantValueExpression(IrisInstantValueExpression.InstantValueType.Nil);
    ...
    {if ("" != null) return tmpExpression;}
        ...
        case CAST:{
          tmpToken = jj_consume_token(CAST);
tmpExpression = new IrisCastExpression();
    ...
    {if ("" != null) return tmpExpression;}
        ...
        case SELF:{
          tmpToken = jj_consume_token(SELF);
...
tmpExpr = new IrisArrayExpression(expressions);
    ...
    {if ("" != null) return tmpExpr;}
    throw new Error("Missing return statement in function");
  }

  final public IrisExpression hash_literal() throws ParseException {LinkedList<IrisHashPair> hashPairs = null;
  Token tmpToken = null;
  IrisExpression tmpExpr = null;
    tmpToken = jj_consume_token(LC);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CAST:
    case SELF:
    case TRUE:
...
tmpExpr = new IrisHashExpression(hashPairs);
  ...
  final public LinkedList<IrisHashPair> hash_pair_list() throws ParseException {IrisExpression tmpKey = null;
...
{if ("" != null) return hashPairs;}
    throw new Error("Missing return statement in function");
  }

  final public IrisExpression field_expression() throws ParseException {LinkedList<IrisIdentifierExpression> tmpList = null;
   IrisIdentifier tmpIdentifier = null;
...
tmpExpression = new IrisIdentifierExpression(tmpIdentifier);
 ...
 {
    if (jj_scan_token(ITERATOR)) return true;
    ...
    if (jj_scan_token(CONLON)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(JOINTS)) return true;
 ...
 {
    if (jj_scan_token(INVOLVES)) return true;
    if (jj_3R_198()) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(SEMICOLON)) return true;
    if (jj_scan_token(GSET)) return true;
    if (jj_scan_token(LB)) return true;
    if (jj_3R_20()) return true;
    if (jj_scan_token(RB)) return true;
    return false;
 ...
 {
    if (jj_scan_token(SEMICOLON)) return true;
    if (jj_scan_token(GROAN)) return true;
    Token xsp;
    xsp = jj_scanpos;
 ...
 {
    if (jj_scan_token(PERSONAL)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(EVERYONE)) return true;
    return false;
  }
  ...
  private boolean jj_3_12()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x14b01c00,0x14801c00,0x0,0x0,0xe0000,0x40000000,0x0,0x100000,0x200000,0x0,0x4000,0x8000,0x10000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x800000,0x2000000,0x1000000,0x0,0x2000000,0x14b01c00,0x14b01c00,0x20000000,0x1000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x40000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x14b01c00,0x40000000,0x0,0x0,0x40000000,0x0,0x0,0x0,0x40000000,0x0,0x40000000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x4000100,0x0,0x4000100,0x20,0x0,0x41507020,0x400,0x4000000,0x4000000,0x0,0x0,0x0,0x0,0x0,0x8000000,0x0,0x0,0x40,0x20,0x0,0x8000000,0x0,0x100000,0x41507020,0x0,0x0,0x0,0x8000000,0x0,0x4000100,0x4000100,0x0,0x0,0x41507020,0x80000000,0x0,0x0,0x0,0x0,0x0,0x41507020,0x1507020,0x41507020,0x400000,0x100000,0x1080000,0x1080000,0x0,0x8000000,0x0,0x0,0x4000100,0x41507020,0x400000,0x100000,0x1407020,0x0,0x0,0x8000000,0x41507020,0x8000000,0x41507020,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x80c0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x100,0x0,0x80c0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80c0,0xf0ff0000,0x3,0x3c,0xf000000,0xc0,0x700,0x80c0,0x0,0x80c0,0x0,0x0,0x0,0x0,0x0,0x0,0x100,0x0,0x0,0x80c0,0x0,0x0,0x0,0x0,0x0,0x0,0x80c0,0x0,0x80c0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x218441f2,0x0,0x0,0x0,0x1f0,0x0,0x0,0x0,0x1f0,0x0,0x1f0,0x1f2,0x0,0x0,0x1f0,0x0,0x0,0x1f0,0x218441f2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x218441f2,0x0,0x0,0x0,0x0,0x0,0x0,0x218441f2,0x218441f2,0x218441f2,0x0,0x0,0x0,0x0,0x1f0,0x0,0x0,0x0,0x0,0x218441f2,0x0,0x0,0x218441f0,0x1f0,0x21800000,0x0,0x218441f2,0x0,0x218441f2,0x1f2,};
   }
